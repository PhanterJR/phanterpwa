// Transcrypt'ed from Python, 2021-03-15 14:32:45
...
var __name__ = 'phanterpwa.frontend.forms';
...
export var SignLockForm =  __class__ ('SignLockForm', [object], {
	...
	get __init__ () {return __get__ (this, function (self) {
		...
		self.element_csrf_token = $ ("[phanterpwa-form='lock'] #phanterpwa-widget-input-input-lock-csrf_token");
		if (self.element_csrf_token.length == 0) {
...
export var CSRFInput =  __class__ ('CSRFInput', [helpers.XmlConstructor], {
	...
	get __init__ () {return __get__ (this, function (self, table_name) {
		...
		helpers.XmlConstructor.__init__ (self, 'div', false, widgets.Input ('{0}-{1}'.format (self.table_name, 'csrf_token'), __kwargtrans__ ({label: 'CSRF Token', py_name: 'csrf_token', value: '', form: self.table_name, validators: ['IS_NOT_EMPTY']})), __kwargtrans__ (attributes));
	});}
});
export var FormWidget =  __class__ ('FormWidget', [helpers.XmlConstructor], {
	...
	get __init__ () {return __get__ (this, function (self, table_name, input_name) {
		...
		self._icon = json_widget.py_get ('icon', null);
	...
	get _process () {return __get__ (this, function (self) {
		...
		if (self._widget_type == 'date' || self._widget_type == 'datetime') {
			...
			var w = widgets.Input ('{0}-{1}'.format (self.table_name, self.input_name), __kwargtrans__ ({label: self.json_widget ['label'], py_name: self.input_name, value: self._value, form: self.table_name, validators: self.validators, kind: 'password', icon: self._icon}));
		}
...
//# sourceMappingURL=phanterpwa.frontend.forms.map
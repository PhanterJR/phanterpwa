// Transcrypt'ed from Python, 2021-03-10 09:46:22
...
var __name__ = 'phanterpwa.frontend.components.events';
...
export var WayHiperlinks =  __class__ ('WayHiperlinks', [Event], {
	...
	get _open_way () {return __get__ (this, function (self, el) {
		...
		window.PhanterPWA.open_way ($ (el).attr ('phanterpwa-way'));
...
//# sourceMappingURL=phanterpwa.frontend.components.events.map
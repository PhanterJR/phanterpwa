// Transcrypt'ed from Python, 2020-04-24 14:04:00
...
export var Error_404 =  __class__ ('Error_404', [gatehandler.ErrorHandler], {
	__module__: __name__,
...
export var Error_401 =  __class__ ('Error_401', [gatehandler.ErrorHandler], {
	__module__: __name__,
	get start () {return __get__ (this, function (self) {
...
export var Error_403 =  __class__ ('Error_403', [gatehandler.ErrorHandler], {
	__module__: __name__,
	get start () {return __get__ (this, function (self) {
		var html = html_base.jquery ();
		html.find ('.image-warnings').attr ('src', '/static/{0}/images/warning.png'.format (window.PhanterPWA.VERSION));

// Transcrypt'ed from Python, 2020-03-31 00:47:13
...
var __name__ = 'phanterpwa.apptools.websocket';
...
export var WebSocketPhanterPWA =  __class__ ('WebSocketPhanterPWA', [object], {
	__module__: __name__,
	get __init__ () {return __get__ (this, function (self, api_websocket_address) {
		var parameters = dict ();
		if (arguments.length) {
			...
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				...
				for (var __attrib0__ in __allkwargs0__) {
					switch (__attrib0__) {
						...
						case 'api_websocket_address': var api_websocket_address = __allkwargs0__ [__attrib0__]; break;
	...
	get start () {return __get__ (this, function (self) {
		...
		if (!(self.manual_connection)) {
			self._ws = new WebSocket (self.api_websocket_address);
			self._authorization = window.PhanterPWA.get_authorization ();
...
//# sourceMappingURL=phanterpwa.apptools.websocket.map
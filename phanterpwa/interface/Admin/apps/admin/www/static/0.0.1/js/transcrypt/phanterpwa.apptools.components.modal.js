// Transcrypt'ed from Python, 2020-03-29 19:45:04
...
var __name__ = 'phanterpwa.apptools.components.modal';
...
export var Modal =  __class__ ('Modal', [object], {
	...
	get __init__ () {return __get__ (this, function (self, target_selector) {
		...
		self.modal_container = DIV (DIV (DIV (DIV (DIV (self.modal_wrapper, __kwargtrans__ ({_class: 'phanterpwa-centralizer-center'})), __kwargtrans__ ({_class: 'phanterpwa-centralizer-horizontal'})), __kwargtrans__ ({_class: 'phanterpwa-centralizer-vertical'})), __kwargtrans__ ({_class: 'phanterpwa-centralizer-wrapper'})), __kwargtrans__ ({_class: 'phanterpwa-component-modal-container phanterpwa-fixed-fulldisplay'}));
	});},
	...
	get open () {return __get__ (this, function (self) {
		...
		modal_container.find ('{0}, {1}, {2}'.format ('phanterpwa-widget.phanterpwa-widget-select', 'phanterpwa-widget.phanterpwa-widget-menubox', 'tr.phanterpwa-widget-table-pagination')).each ((function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
...
//# sourceMappingURL=phanterpwa.apptools.components.modal.map
// Transcrypt'ed from Python, 2020-03-29 19:45:12
...
var __name__ = 'phanterpwa.apptools.components.datetimepicker';
...
export var Datepickers =  __class__ ('Datepickers', [object], {
	...
	get _onChoice () {return __get__ (this, function (self) {
		...
		if (self.onChoice !== null && self.onChoice !== undefined) {
			var iso_format = self._apply_format ('yyyy-MM-dd HH:ss:mm');
			$ (self.target_selector).attr ('phanterpwa-datetimepicker-iso', iso_format);
	...
	get start () {return __get__ (this, function (self) {
		...
		$ ('#phanterpwa_datetimepicker_calendar_{0} {1} .phanterpwa_datetimepicker_unit'.format (self.namespace, '.phanterpwa_datetimepicker_day')).on ('click', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		$ ('.phanterpwa_datetimepicker_summary_container .phanterpwa-models-close').on ('click', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
...
//# sourceMappingURL=phanterpwa.apptools.components.datetimepicker.map
...
class Component(helpers.XmlConstructor):
    def __init__(self, identifier, *content, **attributes):
        ...
        tag = attributes.get("tag", "div")
        attr_wrapper = {
            "_id": self._identifier,
            "_phanterpwa-component": self.identifier,
            "_class": "phanterpwa-component"
        }
        attr_content = {x: attributes[x] for x in attributes if x.startswith("_")}
        if "_class" in attr_content:
        ...
        component_content = helpers.XmlConstructor.tagger(tag, False, *content, **attr_content)
        helpers.XmlConstructor.__init__(self, 'phanterpwa-component', False, component_content, **attr_wrapper)
        self.wrapper_selector = "#{0}".format(
            self._identifier
        )
...
class Input(Component):
    def __init__(self, identifier, **parameters):
        ...
        wrapper_attr = {
            "_class": "phanterpwa-component-wrapper phanterpwa-component-input-wrapper phanterpwa-component-wear-{0}".format(
                self._wear)
        }
        ...
        if self._label is not None:
            ...
            label = LABEL(self._label, _for="phanterpwa-component-input-input-{0}".format(identifier))

        if self._message_error is not None:
            wrapper_attr["_class"] = "{0}{1}".format(wrapper_attr["_class"], " has_error")
        xml_icon = ""
        if self._icon is not None:
            xml_icon = DIV(self._icon, _class="phanterpwa-component-icon-wrapper icon_button wave_on_click")
        ...
        html = DIV(
            INPUT(**{
                "_id": "phanterpwa-component-input-input-{0}".format(identifier),
                "_class": "phanterpwa-component-input-input",
                "_name": self._name,
                "_value": self._value,
            ...
            DIV(
                ...
                _class="phanterpwa-component-check"
            ),
            xml_icon,
            DIV(
                self.get_message_error(),
                _class="phanterpwa-component-message_error phanterpwa-component-input-message_error"
            ),
            **wrapper_attr
        )
        Component.__init__(self, identifier, html, **parameters)
    ...
    def set_message_error(self, message_error):
        jQuery("#phanterpwa-component-{0}".format(self.identifier)).find(
            ".phanterpwa-component-message_error").html(message_error)
        jQuery("#phanterpwa-component-{0}".format(self.identifier)).addClass("has_error")
        self._message_error

    def del_message_error(self):
        self.set_message_error("")
        jQuery("#phanterpwa-component-{0}".format(self.identifier)).removeClass("has_error")
    ...
    def _add_div_animation(self, el):
        wrapper = el.find(".phanterpwa-component-wrapper")
        ...
        if callable(self._icon_on_click):
            ...
            self._datetimepicker = datetimepicker.Datepickers(
                ...
                **{"date_type": "date", "format": self._format,
                "id_input_target": jQuery(self.wrapper_selector).find("input")}
            )
    ...
    def _switch_focus(self, el):
        ...
        if el.js_is(":focus"):
            jQuery(".phanterpwa-component-wrapper").removeClass("focus").removeClass("pre_focus")
            p.addClass("focus")
        else:
            p.removeClass("focus")
    ...
    def _binds(self):
        target = jQuery(self.wrapper_selector)
        ...
        if self._icon is not None:
            target.find(".phanterpwa-component-icon-wrapper").off("click.phanterpwa-component-icon-wrapper").on(
                "click.phanterpwa-component-icon-wrapper",
    ...
    def value(self):
        self._value = jQuery("#phanterpwa-component-input-input-{0}".format(self.identifier)).val()
        return self._value
...
class Select(Component):
    def __init__(self, identifier, **parameters):
        ...
        if self._icon is not "":
            xml_icon = DIV(self._icon, _class="phanterpwa-component-icon-wrapper")
        wrapper_attr = {
            "_class": "phanterpwa-component-wrapper phanterpwa-component-select-wrapper phanterpwa-component-wear-{0}".format(
                self._wear)
        }
        parameters["_id"] = identifier
        self.identifier = identifier
        ...
        if self._label is not None:
            wrapper_attr["_class"] = "{0}{1}".format(wrapper_attr["_class"], " has_label")
            label = LABEL(
                self._label, _for="phanterpwa-component-select-input-{0}".format(identifier),
                _class="phanterpwa-component-select-label"
            )
        ...
        if self._value is not "":
            wrapper_attr["_class"] = "{0}{1}".format(wrapper_attr["_class"], " has_value")
        select = SELECT(_class="phanterpwa-component-select-select", _name=self._name)
        ul = UL(_class="phanterpwa-component-select-options-wrapper")
        self._xml_modal = ul
        ...
        html = DIV(
            INPUT(**{
                "_id": "phanterpwa-component-select-input-{0}".format(identifier),
            ...
            DIV(
                ...
                _class="phanterpwa-component-select-caret"
            ),
            xml_icon,
            DIV(
                I(_class="fas fa-check"),
            ...
            DIV(
                self.get_message_error(),
                _class="phanterpwa-component-message_error phanterpwa-component-select-message_error"
            ),
            **wrapper_attr
        )
        Component.__init__(self, identifier, html, **parameters)
    ...
    def _create_xml_modal(self):
        ...
        if self._data is not []:
            if self._can_empty:
                if self._value is "":
                    icon_empty = DIV(self._icon_option_selected, _class="phanterpwa-component-select-li-icon")
                else:
                    icon_empty = DIV(self._icon_option, _class="phanterpwa-component-select-li-icon")

                ul.append(LI(SPAN(I18N("Empty")),
                    icon_empty, **{
                        "_data-value": "",
                        "_data-target": "phanterpwa-component-select-input-{0}".format(self.identifier),
                        "_data-text": "",
                        "_class": "phanterpwa-component-select-li-option empty"
                }))
            for vdata in self._data:
                if self._value is not "":
                    if vdata[0] == self._value:
                        ul.append(LI(SPAN(vdata[1]),
                            DIV(self._icon_option_selected, _class="phanterpwa-component-select-li-icon"), **{
                                "_data-value": vdata[0],
                                "_data-text": vdata[1],
                                "_data-target": "phanterpwa-component-select-input-{0}".format(self.identifier),
                                "_class": "phanterpwa-component-select-li-option selected"
                        }))

                    else:
                        ul.append(LI(SPAN(vdata[1]),
                            DIV(self._icon_option, _class="phanterpwa-component-select-li-icon"), **{
                                "_data-value": vdata[0],
                                "_data-text": vdata[1],
                                "_data-target": "phanterpwa-component-select-input-{0}".format(self.identifier),
                                "_class": "phanterpwa-component-select-li-option"
                        }))
                else:
                    ul.append(LI(SPAN(vdata[1]),
                        DIV(self._icon_option, _class="phanterpwa-component-select-li-icon"), **{
            ...
            icon_placeholder = DIV(
                DIV(
                    DIV(self._icon_plus, _class="link phanterpwa-component-select-li-icon_plus"),
                    DIV(
                        INPUT(_class="phanterpwa-component-select-li-input"),
                        DIV(self._icon_confirm, _class="phanterpwa-component-select-li-icon_confirm link"),
                        _class="phanterpwa-component-select-li-input-editable"
                    ),
                    _class="phanterpwa-component-select-li-input-editable-wrapper"
                ),
                _class="phanterpwa-component-select-li-icon_plus-wrapper"
            )

            if self._placeholder is not None:
                if self._editable:
                    ul.insert(0, LI(SPAN(self._placeholder, _class="phanterpwa-component-select-placeholder"),
                        icon_placeholder, **{
                            "_data-value": "",
                            "_data-target": "phanterpwa-component-select-input-{0}".format(self.identifier),
                            "_data-text": "",
                            "_class": "phanterpwa-component-select-li-title has_editable"
                    }))
                else:
                    ul.insert(0, LI(SPAN(self._placeholder, _class="phanterpwa-component-select-placeholder"),
                        "", **{
                            ...
                            "_data-target": "phanterpwa-component-select-input-{0}".format(self.identifier),
                            "_data-text": "",
                            "_class": "phanterpwa-component-select-li-title"
                    }))
            else:
                if self._editable:
                    ul.insert(0, LI(SPAN(self._placeholder, _class="phanterpwa-component-select-placeholder"),
    ...
    def set_message_error(self, message_error):
        jQuery("#{0}".format(self.identifier)).find(".phanterpwa-component-message_error").html(message_error)
    ...
    def _switch_pre_focus(self, el):
        ...
        if p.hasClass("pre_focus"):
            ...
            jQuery(".phanterpwa-component-select-wrapper").removeClass("pre_focus")
            p.addClass("pre_focus")

    def open_modal(self, el):

        self.modal = PseudoModal(
            "#phanterpwa-component-select-input-{0}".format(self.identifier),
            self._xml_modal,
    ...
    def _switch_focus(self, el):
        ...
        if p.hasClass("focus"):
            ...
            jQuery(".phanterpwa-component-select-wrapper").removeClass("focus").removeClass("pre_focus")
            p.addClass("focus")
    ...
    def add_new_value(self, value):
        ...
        if new_value is not "":
            ...
            if not has_value:
                ...
                self._value = new_key
                jQuery("#phanterpwa-component-select-input-{0}".format(self.identifier)).val(new_value)
                target = jQuery(self.wrapper_selector)
                target.find("select.phanterpwa-component-select-select").find("option").removeAttr("selected")
                target.find("select.phanterpwa-component-select-select").append(
                    OPTION(new_value, _value=new_key, _selected="selected").jquery()
                )
                target.find("select.phanterpwa-component-select-select").find(
    ...
    def _process_option(self, el):
        ...
        jQuery(el).find(".phanterpwa-component-select-li-icon").html(XML(self._icon_option_selected).jquery())
    ...
    def _binds_modal_content(self):
        jQuery(".phanterpwa-component-pseudomodal-content").find(
            ".phanterpwa-component-select-li-option"
        ).off(
        ...
        if self._editable:
            jQuery(".phanterpwa-component-pseudomodal-content").find(
                ".phanterpwa-component-select-li-icon_plus"
            ).off(
                "click.option_select_modal_content"
            ).on(
                "click.option_select_modal_content",
            ...
            jQuery(".phanterpwa-component-pseudomodal-content").find(
                ".phanterpwa-component-select-li-icon_confirm"
            ).off(
                "click.option_select_modal_content"
            ).on(
                "click.option_select_modal_content",
...
class ListString(Component):
    def __init__(self, identifier, **parameters):
        ...
        self._input_value = []
        wrapper_attr = {
            "_class": "phanterpwa-component-wrapper {0} phanterpwa-component-wear-{1}".format(
                "phanterpwa-component-list_string-wrapper",
                self._wear
            )
        }
        parameters["_id"] = identifier
        ...
        if self._label is not None:
            wrapper_attr["_class"] = "{0}{1}".format(wrapper_attr["_class"], " has_label")
            label = LABEL(self._label, _for="phanterpwa-component-list_string-input-{0}".format(identifier))
        ...
        html = DIV(
            DIV(
                self._xml_list_string,
                _id="phanterpwa-component-list_string-list_values-{0}".format(identifier),
                _class="phanterpwa-component-list_string-list_values",
                _tabindex=0
            ),
            INPUT(**{
                "_id": "phanterpwa-component-list_string-input-{0}".format(identifier),
                "_class": "phanterpwa-component-list_string-input",
                "_name": self._name,
            ...
            DIV(
                ...
                _class="phanterpwa-component-list_string-list_predefinitions_values"
            ),
            DIV(
                I(_class="fas fa-check"),
                _class="phanterpwa-component-check"
            ...
            DIV(
                self.get_message_error(),
                _class="phanterpwa-component-message_error phanterpwa-component-list_string-message_error"
            ),
            **wrapper_attr
        )
        Component.__init__(self, identifier, html, **parameters)
                        ...
                        xml.append(
                            DIV(
                                ...
                                DIV(I(_class="fas fa-times"),
                                    _class="phanterpwa-component-list_string-value-icon_close icon_button wave_on_click"),
                                **{
                                    "_data-value": x[0],
                                    "_class": "phanterpwa-component-list_string-value-content",
                                    "_tabindex": "0"
                                }
                            )
                        )
            ...
            if self._editable:
                xml.append(DIV(
                    DIV(
                        ...
                        _class="icon_button wave_on_click phanterpwa-component-list_string-value-icon_plus"
                    ),
                    _class="phanterpwa-component-list_string-plus_icon-container",
                    _tabindex=0
                ))
                ...
                xml.append(
                    DIV(
                        ...
                        DIV(I(_class="fas fa-plus"),
                            _class="phanterpwa-component-list_string-value-icon_plus_predifinition icon_button wave_on_click"),
                        **{
                            "_data-value": x,
                            "_class": "phanterpwa-component-list_string-value-predefinition-content",
                            "_tabindex": "0"
                        }
                    )
                )
    ...
    def add_new_value(self, value):
        ...
        self._xml_list_predefinition_string.html_to(
            target.find(".phanterpwa-component-list_string-list_predefinitions_values")
        )
        jQuery("#phanterpwa-component-list_string-input-{0}".format(
            self.identifier)).val(JSON.stringify(JSON.stringify(self._input_value)))
        jQuery("#phanterpwa-component-list_string-list_values-{0}".format(self.identifier)).html(
            self._xml_list_string.jquery()
        ).find(".phanterpwa-component-list_string-plus_icon-container").find(
            ".phanterpwa-component-list_string-value-icon_plus"
        ).off(
        ...
        jQuery("#phanterpwa-component-list_string-list_values-{0}".format(self.identifier)).find(
            ".phanterpwa-component-list_string-value-icon_close").off("click.remove_lstr_item").on(
    ...
    def _save_new(self):
        ...
        target = jQuery(self.wrapper_selector)
        val = target.find('.phanterpwa-component-list_string-new_value-container').find("input").val()
        if val is not "":
    ...
    def _on_click_remove(self, el):
        ...
        target.find(".phanterpwa-component-list_string-value-predefinition-content").find(
            ".phanterpwa-component-list_string-value-icon_plus_predifinition"
        ...
        jQuery("#phanterpwa-component-list_string-list_values-{0}".format(self.identifier)).html(
            ...
            ".phanterpwa-component-list_string-plus_icon-container"
        ).find(
            ".phanterpwa-component-list_string-value-icon_plus"
        ).off(
            "click.icon_plus_lstr"
    ...
    def _on_click_icon_plus(self, el):
        if callable(self._on_click_new):
            ...
            p_cont.html(CONCATENATE(
                DIV(
                    INPUT(),
                    _class="phanterpwa-component-list_string-new_value-container"
                ),
                DIV(
                    I(_class="fas fa-check"),
                    _class="icon_button wave_on_click phanterpwa-component-list_string-value-save"
                )
            ).jquery())
            p_cont.find(".phanterpwa-component-list_string-value-save").off("click.on_icon_save_lstr").on(
    ...
    def _close_on_click_out(self, event, el):
        target = jQuery(self.wrapper_selector)
        if jQuery(event.target).closest(".phanterpwa-component-list_string-plus_icon-container").length == 0:

            target.find(".phanterpwa-component-list_string-plus_icon-container").html(
                DIV(
                    I(_class="fas fa-plus"),
                    _class="icon_button wave_on_click phanterpwa-component-list_string-value-icon_plus"
                ).jquery()
            ...
            jQuery("body").off("click.close_input_plus_lstr")
            target.find(".phanterpwa-component-list_string-plus_icon-container").removeClass("has_input").find(
                ".phanterpwa-component-list_string-value-icon_plus"
    ...
    def _binds(self):
        ...
        target.find(".phanterpwa-component-list_string-list_values").off("focusin.list_string_vals").on(
            "focusin.list_string_vals",
            lambda: self._switch_focus(this),
        )

        target.find(".phanterpwa-component-list_string-list_values").off("focusout.list_string_vals").on(
            "focusout.list_string_vals",
            lambda: self._switch_focus(this),
        )

        target.find(".phanterpwa-component-list_string-plus_icon-container").find(
            ".icon_button"
        ).off("click.icon_plus_lstr").on(
            "click.icon_plus_lstr",
            lambda: self._on_click_icon_plus(this)
        ...
        target.find("label").off("click.phanterpwa-event-input_materialize").on(
            "click.phanterpwa-event-input_materialize",
            lambda: target.find(".phanterpwa-component-list_string-list_values").focus()
        )
        jQuery("#phanterpwa-component-list_string-list_values-{0}".format(self.identifier)).find(
            ".phanterpwa-component-list_string-value-icon_close").off("click.remove_lstr_item").on(
            "click.remove_lstr_item",
...
class Textarea(Component):
    def __init__(self, identifier, **parameters):
        ...
        self._form = parameters.get("form", None)
        wrapper_attr = {
            "_class": "phanterpwa-component-wrapper phanterpwa-component-textarea-wrapper phanterpwa-component-wear-{0}".format(
                self._wear)
        }
        parameters["_id"] = identifier
        if "_class" in parameters:
        ...
        if self._label is not None:
            wrapper_attr["_class"] = "{0}{1}".format(wrapper_attr["_class"], " has_label")
            label = LABEL(self._label, _for="phanterpwa-component-textarea-textarea-{0}".format(identifier))
        ...
        html = DIV(
            TEXTAREA(
                self._value,
                **{
                    "_id": "phanterpwa-component-textarea-textarea-{0}".format(identifier),
                    "_class": "phanterpwa-component-textarea-textarea",
                    "_name": self._name,
                    "_placeholder": self._placeholder,
                    "_data-validators": JSON.stringify(self._validator),
                    "_data-form": self._form
            ...
            DIV(
                self.get_message_error(),
                _class="phanterpwa-component-message_error phanterpwa-component-textarea-message_error"
            ),
            **wrapper_attr
        )
        Component.__init__(self, identifier, html, **parameters)
...
class Inert(Component):
    def __init__(self, identifier, **parameters):
        ...
        self._form = parameters.get("form", None)
        wrapper_attr = {
            "_class": "phanterpwa-component-wrapper its_disabled phanterpwa-component-wear-{0} {1}".format(
                self._wear,
                "phanterpwa-component-inert-wrapper"
            )
        }
        parameters["_id"] = identifier
        if "_class" in parameters:
        ...
        if self._label is not None:
            wrapper_attr["_class"] = "{0}{1}".format(wrapper_attr["_class"], " has_label")
            label = LABEL(self._label, _for="phanterpwa-component-inert-inert-{0}".format(identifier))
        if self._value is not "":
            wrapper_attr["_class"] = "{0}{1}".format(wrapper_attr["_class"], " has_value")

        html = DIV(
            INPUT(**{
                "_id": "phanterpwa-component-inert-input-{0}".format(identifier),
                "_class": "phanterpwa-component-inert-input",
                "_name": self._name,
                "_value": self._value,
                "_data-form": self._form,
                "_disabled": "disabled"
...
class CheckBox(Component):
    def __init__(self, identifier, **parameters):
        ...
        wrapper_attr = {
            "_class": "phanterpwa-component-wrapper phanterpwa-component-checkbox-wrapper phanterpwa-component-wear-{0}".format(
                self._wear)
        }
        parameters["_id"] = identifier
        if "_class" in parameters:
        ...
        if self._label is not None:
            wrapper_attr["_class"] = "{0}{1}".format(wrapper_attr["_class"], " has_label")
            label = LABEL(self._label, _for="phanterpwa-component-checkbox-input-{0}".format(identifier))
        _checked = None
        ...
        html = DIV(
            INPUT(**{
                "_id": "phanterpwa-component-checkbox-input-{0}".format(identifier),
                "_class": "phanterpwa-component-checkbox-input",
                "_name": self._name,
                "_value": self._value,
                "_placeholder": self._placeholder,
                "_type": "checkbox",
            ...
            DIV(
                DIV(
                    I(_class="fas fa-check"),
                    _class="phanterpwa-component-checkbox-true"),
                DIV(_class="phanterpwa-component-checkbox-option-container"),
                _class="phanterpwa-component-checkbox-checkbox",
                _tabindex=0
            ),
            label,
            **wrapper_attr
    ...
    def _binds(self):
        target = jQuery(self.wrapper_selector)
        target.find(".phanterpwa-component-checkbox-checkbox").off("click.phanterpwa-event-checkbox-switch").on(
            "click.phanterpwa-event-checkbox-switch",
            lambda: self._switch_value(this)
        )
        target.find(".phanterpwa-component-checkbox-checkbox").off("focusin.phanterpwa-event-checkbox-focus").on(
            "focusin.phanterpwa-event-checkbox-focus",
            lambda: self._switch_focus(this)
        )
        target.find(".phanterpwa-component-checkbox-checkbox").off("focusout.phanterpwa-event-checkbox-focus").on(
...
class MenuBox(Component):
    def __init__(self, identifier, **parameters):
        ...
        html = DIV(
            self._icon,
            _class="phanterpwa-component-menubox-icon wave_on_click icon_button",
    ...
    def _on_click(self, el):
        ...
        self.modal = PseudoModal(
            ...
            DIV(
                self._xml_menu,
                _id="phanterpwa-component-menubox-options-content-{0}".format(self.identifier),
                _class="phanterpwa-component-menubox-options-content"
            ),
            vertical=True,
            z_index=self._z_index,
            recalc_on_scroll=self._recalc_on_scroll,
        ...
        self.modal.start()
        jQuery("#phanterpwa-component-menubox-options-content-{0}".format(
...
class PseudoModal():
    ...
    def _close_on_click_out(self, event):
        if not jQuery(event.target).hasClass("phanterpwa-select-touchpad") and \
                not jQuery(event.target).hasClass("phanterpwa-component-select-label"):
...
class Preloaders(Component):
    def __init__(self, identifier, **parameters):
        ...
        Component.__init__(self, identifier, self["_{0}".format(self._preloader)](), **parameters)
...
class Table(Component):
    def __init__(self, identifier, *content, **parameters):
        ...
        self.__child_html = TABLE(
            *content,
            _class="phanterpwa-component-table p-row"
        )
        Component.__init__(self, identifier, self.__child_html, **parameters)
...
class TableHead(Component):
                    ...
                    if x in self._sortable:
                        if self._sort_by == x:
                            self.__child_html.append(TH(DIV(
                                    x,
                                    **{"_class": "phanterpwa-component-table-head-th-sortable",
                                    "_data-value": x}
                                ),
                                _class="phanterpwa-component-table-head-th enabled {0}".format(sort_order)))
                        else:
                            self.__child_html.append(TH(DIV(
                                    x,
                                    **{"_class": "phanterpwa-component-table-head-th-sortable",
                                ...
                                _class="phanterpwa-component-table-head-th"))
    ...
    def sorted_field(self):
        target = jQuery(self.wrapper_selector)
        enabled = target.find(".phanterpwa-component-table-head-th.enabled")
        container = enabled.find(".phanterpwa-component-table-head-th-sortable")
        sort = "asc"
    ...
    def append(self, value):
        self.__child_html.content.append(TH(value, _class="phanterpwa-component-table-head-th"))

    def insert(self, pos, value):
        self.__child_html.content.insert(pos, TH(value, _class="phanterpwa-component-table-head-th"))

    def _after_click_sortable(self, ev, el):
        el = jQuery(el)
        p = el.parent()
        if p.hasClass("asc"):
            jQuery(self.wrapper_selector).find(
                ".phanterpwa-component-table-head-th").removeClass("asc")
            p.addClass("desc")
        elif p.hasClass("desc"):
            jQuery(self.wrapper_selector).find(
                ".phanterpwa-component-table-head-th").removeClass("desc")
            p.addClass("asc")
        else:
            jQuery(self.wrapper_selector).find(
                ".phanterpwa-component-table-head-th").removeClass("asc").removeClass("desc").removeClass("enabled")
    ...
    def start(self):
        target = jQuery(self.wrapper_selector)
        container = target.find(".phanterpwa-component-table-head-th").find(".phanterpwa-component-table-head-th-sortable")
...
class TableData(Component):
    def __init__(self, identifier, *content, **parameters):
        ...
        self.__child_html = CONCATENATE()
        for x in content:
            self.__child_html.append(TD(x, _class="phanterpwa-component-table-data-td"))
        Component.__init__(self, identifier, self.__child_html, **parameters)
        self.tag = "tr"
...
class TableFooterPagination(Component):
    def __init__(self, identifier, *content, **parameters):
        self.identifier = identifier
        self._table = None
    ...
    def _create_footer(self):
        first_button = DIV(
            ...
            **{"_data-page": 1,
                "_class": "phanterpwa-component-pagination-first_button{0}".format(
        ...
        previous_button = DIV(
            ...
            **{"_data-page": self._page - 1,
                "_class": "phanterpwa-component-pagination-previous_button{0}".format(
                    " disabled" if self._page == 1 else "")
            }
        )
        status_button = DIV(
            I18N("Page "), self._page, I18N(" of "), self._total_pages,
            **{"_id": "phanterpwa-component-pagination-status_button-{0}".format(self.identifier),
                "_class": "phanterpwa-component-pagination-status_button"
            }
        )
        next_button = DIV(
            I(_class="fas fa-angle-right"),
            **{"_data-page": self._page + 1,
                "_class": "phanterpwa-component-pagination-next_button{0}".format(
        ...
        last_button = DIV(
            ...
            **{"_data-page": self._total_pages,
                "_class": "phanterpwa-component-pagination-last_button{0}".format(
                    " disabled" if self._page == self._total_pages else "")
            }
        )
        ...
        self.__child_html = TD(
            DIV(
                ...
                next_button,
                last_button,
                _id="phanterpwa-component-pagination-container-{0}".format(self.identifier),
                _class="phanterpwa-component-pagination-container"
            ),
            _id="phanterpwa-component-table-pagination-td-{0}".format(self.identifier),
    ...
    def _pages_panel(self):
        pages_panel = DIV(
            _class="phanterpwa-component-pagination-pages_panel p-row"
        )
        mid = 13
        if self.page > mid:
        ...
        self._modal = PseudoModal(
            "#phanterpwa-component-pagination-container-{0}".format(self.identifier),
            pages_panel,
            z_index=self._z_index,
            recalc_on_scroll=self._recalc_on_scroll
        )
    ...
    def start(self):
        ...
        jQuery("#phanterpwa-component-table-pagination-td-{0}".format(self.identifier)).attr("colspan", self._colspan)
        target.find("#phanterpwa-component-pagination-status_button-{0}".format(self.identifier)).off(
            "click.table_pagination"
        ).on(
            "click.table_pagination",
            lambda: self._open_panel_pages(this)
        )
        pre = target.find(".phanterpwa-component-pagination-previous_button")
        if not pre.hasClass("disabled"):
            pre.off("click.btn_pagination").on("click.btn_pagination", lambda: self._on_click_buttom_page(this))
        nex = target.find(".phanterpwa-component-pagination-next_button")
        if not nex.hasClass("disabled"):
            nex.off("click.btn_pagination").on("click.btn_pagination", lambda: self._on_click_buttom_page(this))
        fir = target.find(".phanterpwa-component-pagination-first_button")
        if not fir.hasClass("disabled"):
            fir.off("click.btn_pagination").on("click.btn_pagination", lambda: self._on_click_buttom_page(this))
        las = target.find(".phanterpwa-component-pagination-last_button")
...
class Image(Component):
    def __init__(self, identifier, **parameters):
        ...
        self.__child_html = DIV(
            _id="phanterpwa-component-image-wrapper-{0}".format(identifier),
            _class="phanterpwa-component-image-wrapper"
        )
        self.iniciate = False
        if "_class" in parameters:
    ...
    def _binds(self):
        GalleryInput(
            "#phanterpwa-component-image-wrapper-{0}".format(self.identifier),
            **{
                "name": self._name,
                "cutter": self._cutter,
...
class GalleryInput():
    def __init__(self, target_selector, **parameters):
        ...
        self.config["element"] = jQuery(self.wrapper_selector)
    ...
    def addInputPanel(self):
        ...
        jQuery(self.wrapper_selector).html(
            html.xml()
        ).promise().then(

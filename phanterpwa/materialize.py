...
class MaterializeButtonLeftSubMenu(XmlConstructor):
    def __init__(self, _id, label, **attributes):
        self._id = _id
        self.label = label
        self.initial_class = "materialize-component-left-menu-submenu-button link"
        attributes["_id"] = "materialize-component-left-menu-submenu-button-%s" % _id
        if "_class" in attributes:
            self.initial_class = " ".join([
                attributes['_class'].strip(),
                "materialize-component-left-menu-submenu-button link"])
        attributes['_class'] = self.initial_class
        content = [
            DIV(
                I("chevron_right", _class="material-icons"),
                _class="materialize-component-left-menu-submenu-icon-container"),
            DIV(self.label, _class="materialize-component-left-menu-submenu-label"),
        ]
        XmlConstructor.__init__(self, 'div', False, *content, **attributes)


class MaterializeButtonLeftMenu(XmlConstructor):
    def __init__(self, _id, label, icon_name, **attributes):
        self._id = _id
        self.label = label
        self.icon_name = icon_name
        self.submenus = []
        self.componentSubmenu = MaterializeButtonLeftSubMenu
        initial_class = "materialize-component-left-menu"
        initial_id = "materialize-component-left-menu-%s" % _id
        self.button_attributes = attributes
        self.button_attributes["_cmd_left_menu"] = "link"
        if "_class" in self.button_attributes:
            self.button_attributes["_class"] = " ".join([
                self.button_attributes['_class'].strip(),
                "materialize-component-left-menu-button link"])
        else:
            self.button_attributes["_class"] = "materialize-component-left-menu-button link"
    ...
    def _update_content(self):
        ...
        attributes = self.button_attributes
        if self.submenus:
            attributes["_target_submenu"] = "materialize-component-left-menu-submenu-from-%s" % self._id
            html_submenus = DIV(
                *self.submenus,
                _id=attributes["_target_submenu"],
                _class="materialize-component-left-menu-submenu-container")
        self.content = [
            DIV(
                DIV(I(self.icon_name, _class="material-icons"),
                    _class="materialize-component-left-menu-icon-container"),
                DIV(self.label, _class="materialize-component-left-menu-label"),
                **attributes),
            html_submenus
        ]


class MaterializeButtonLeftMenuPlus(XmlConstructor):
    def __init__(self, _id, label, icon_name, **attributes):
        self._id = _id
        self.label = label
        self.icon_name = icon_name
    ...
    def _update_content(self):
        ...
        self.content = [
            DIV(
                DIV(
                    DIV(
                        I(self.icon_name, _class="material-icons"),
                        DIV(
                            I("add", _class="material-icons"),
                            _class="materialize-component-left-menu-icon-plus"),
                        _class="materialize-component-left-menu-icon-plus-container"),
                    _class="materialize-component-left-menu-icon-container"),
                DIV(self.label, _class="materialize-component-left-menu-label"),
                **attributes),
            html_submenus
...
class MaterializeButtonLeftMenuEdit(XmlConstructor):
    def __init__(self, _id, label, icon_name, **attributes):
        self._id = _id
        self.label = label
        self.icon_name = icon_name
            ...
            DIV(
                DIV(
                    DIV(
                        I(self.icon_name, _class="material-icons"),
                        DIV(
                            I("create", _class="material-icons"),
                            _class="materialize-component-left-menu-icon-plus"),
                        _class="materialize-component-left-menu-icon-plus-container"),
                    _class="materialize-component-left-menu-icon-container"),
                DIV(self.label, _class="materialize-component-left-menu-label"),
...
class MaterializeButtonLeftUserMenu(XmlConstructor):
    def __init__(self, _id, name_user="Nome usuário", url_image_user="/static/images/user.png", **attributes):
        ...
        self.submenus = []
        self._image = IMG(
            _id="materialize-component-left-menu-url-imagem-user",
            _src=url_image_user,
            _alt="user avatar")
        self.componentSubmenu = MaterializeButtonLeftSubMenu
        initial_class = "materialize-component-left-menu"
        ...
        if "_class" in self.button_attributes:
            self.button_attributes["_class"] = " ".join([
                self.button_attributes['_class'].strip(),
                "materialize-component-left-menu-button-user cmp-bar-user-img link"])
        else:
            self.button_attributes["_class"] = "materialize-component-left-menu-button link"
        XmlConstructor.__init__(self, 'div', False, _id=initial_id, _class=initial_class)
        self._update_content()
    ...
    def _update_content(self):
        ...
        self.content = [
            DIV(
                DIV(
                    DIV(self._image,
                        _class="materialize-component-left-menu-image-user"),
                    _class="materialize-component-left-menu-image-user-container"),
                DIV(self.name_user,
                    _id="materialize-component-left-menu-name-user",
                    _class="materialize-component-left-menu-label"),
                **attributes),
            html_submenus
        ]
